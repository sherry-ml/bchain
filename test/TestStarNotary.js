...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(name, 'Starry Token');
    assert.equal(symbol, 'ST721');
});
...
it('lets a user transfer a star', async() => {
    ...
    let starId = 9 ;
    // 1. create a Star with different tokenId
    await instance.createStar('awesome star 9', starId, {from: owner});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let starId = 10 ;
    // 1. create a Star with different tokenId
    await instance.createStar('awesome star 10', starId, {from: owner});
